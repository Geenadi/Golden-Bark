...
import './About.css';
import peelersImage from '../assets/cinnamon_peelers.webp';
import harvestImage from '../assets/man-preparing-cinnamon-sticks.webp';
import leavesImage from '../assets/cinnamon-with-leaves.webp';
...
export default function About() {
  ...
  return <div className="about-page about-editorial">
    <section className="about-hero">
      <div className="about-hero__image"><img src={peelersImage} alt="Sri Lankan cinnamon artisan at work" fetchPriority="high" loading="eager" decoding="async" /></div>
